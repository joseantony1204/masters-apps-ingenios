...
class MaestrasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $dataMaestra = [
            ...
            [ 'id' => 891, 'codigo' => NULL, 'nombre' => 'Pestañas', 'padre' => 889, 'jerarquia' => NULL, 'observacion' => 'ti ti-sparkles'],
            [ 'id' => 892, 'codigo' => NULL, 'nombre' => 'Color cabello', 'padre' => 889, 'jerarquia' => NULL, 'observacion' => 'ti ti-color-swatch'],
            [ 'id' => 893, 'codigo' => NULL, 'nombre' => 'Uñas', 'padre' => 889, 'jerarquia' => NULL, 'observacion' => 'ti ti-hand-stop'],
            [ 'id' => 894, 'codigo' => NULL, 'nombre' => 'Depilacion facial', 'padre' => 889, 'jerarquia' => NULL, 'observacion' => 'ti ti-tweezers'],
            ...
            [ 'id' => 947, 'codigo' => NULL, 'nombre' => 'Maquillaje', 'padre' => 889, 'jerarquia' => NULL, 'observacion' => 'ti ti-brush'],
            [ 'id' => 948, 'codigo' => NULL, 'nombre' => 'Cejas', 'padre' => 889, 'jerarquia' => NULL, 'observacion' => 'ti ti-eye'],
            [ 'id' => 949, 'codigo' => NULL, 'nombre' => 'Limpieza facial', 'padre' => 889, 'jerarquia' => NULL, 'observacion' => 'ti ti-face-id'],
            [ 'id' => 950, 'codigo' => NULL, 'nombre' => 'Tratamientos capilares', 'padre' => 889, 'jerarquia' => NULL, 'observacion' => 'ti ti-droplet'],
            [ 'id' => 951, 'codigo' => NULL, 'nombre' => 'Alisados', 'padre' => 889, 'jerarquia' => NULL, 'observacion' => 'ti ti-ironing-3'],
            [ 'id' => 952, 'codigo' => NULL, 'nombre' => 'Masajes', 'padre' => 889, 'jerarquia' => NULL, 'observacion' => 'ti ti-spa'],
            ...
            [ 'id' => 984, 'codigo' => 'reportes', 'nombre' => 'REPORTES', 'padre' => 3, 'jerarquia' => 6, 'observacion' => 'ti ti-dots'],
            [ 'id' => 985, 'codigo' => 'index', 'nombre' => 'LISTAR', 'padre' => 4, 'jerarquia' => 984, 'observacion' => NULL],
        ];
