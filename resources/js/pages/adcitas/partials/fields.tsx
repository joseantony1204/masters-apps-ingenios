            ...
            <div className="col-md-12">
                <div className="form-group">
                    ...
                    <input 
                        ...
                        id="cupon" 
                        name="cupon" 
                        className={`form-control ${errors.cupon ? 'is-invalid' : ''}`}
                        value={data.cupon}
                        onChange={e => setData('cupon', e.target.value)}
                        placeholder="Cupon" 
                    />
                    {errors.cupon && <div className="invalid-feedback" role="alert"><strong>{errors.cupon}</strong></div>}
                </div>
            </div>            
            <div className="col-md-12">
                <div className="form-group">
                    ...
                    />
                    {errors.cliente_id && <div className="invalid-feedback" role="alert"><strong>{errors.cliente_id}</strong></div>}
                </div>
            </div>            
            <div className="col-md-12">
                <div className="form-group">
