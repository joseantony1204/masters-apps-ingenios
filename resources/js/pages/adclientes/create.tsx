...
export default function Create({ personas, personasnaturales, clientes, tpidentificacionList, sexosList, ocupacionesList, estadosList }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        fechaingreso: clientes.fechaingreso || today,                           
        estado_id: clientes.estado_id || '', 
    });
    
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('adclientes.store'));
    };
