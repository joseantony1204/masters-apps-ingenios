...
export default function Index({ cfmaestras }: Props) {
                    ...
                    <div className="card-header">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <div className="float-right">
                                <a className="btn btn-sm btn-light-primary " href={ route('cfmaestra.create') }><i className="fa fa-fw fa-plus"></i> Agregar</a>
                            </div>
                        </div>
                    </div>	
                    
                    <div className="card-body">
                        <Table cfmaestras={cfmaestras}/>
                    </div>
                </div>
            </div>
        </div>
