...
export default function Edit({ ftturnos}: Props) {
    const { data, setData, put, delete: destroy, processing, errors } = useForm({
        ...
        codigo: ftturnos.codigo || '',
                             
        descripcion: ftturnos.descripcion || '',
                             
        observaciones: ftturnos.observaciones || '',
                             
        baseinicial: ftturnos.baseinicial || '',
                             
        fecha: ftturnos.fecha || '',
                             
        fechanaapertura: ftturnos.fechanaapertura || '',
                             
        fechanacierre: ftturnos.fechanacierre || '',
                             
        persona_id: ftturnos.persona_id || '',
                             
        terminal_id: ftturnos.terminal_id || '',
                             
        estado_id: ftturnos.estado_id || '',
                             
        created_by: ftturnos.created_by || '',
                             
        updated_by: ftturnos.updated_by || '',
                             
        deleted_by: ftturnos.deleted_by || '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('ftturnos.update', data.id));
    };

    const handleDelete = () => {
        if (confirm('¿Seguro que quiere eliminar este elemento?')) {
            destroy(route('ftturnos.destroy', data.id));
        }
    };
                            ...
                            <div className="col-12">
                                <div className="row align-items-end justify-content-between g-3">
                                    ...
                                    <div className="col-sm-auto btn-page">
                                        <a href={route('ftturnos.index')} className="btn btn-outline-secondary">Cancelar</a> 
