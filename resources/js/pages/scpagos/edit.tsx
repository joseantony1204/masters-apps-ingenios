...
export default function Edit({ scpagos}: Props) {
    const { data, setData, put, delete: destroy, processing, errors } = useForm({
        ...
        referencia_pasarela: scpagos.referencia_pasarela || '',
                             
        estado_id: scpagos.estado_id || '',
                             
        metodo_id: scpagos.metodo_id || '',
                             
        suscripcion_id: scpagos.suscripcion_id || '',
                             
        created_by: scpagos.created_by || '',
                             
        updated_by: scpagos.updated_by || '',
                             
        deleted_by: scpagos.deleted_by || '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('scpagos.update', data.id));
    };

    const handleDelete = () => {
        if (confirm('¿Seguro que quiere eliminar este elemento?')) {
            destroy(route('scpagos.destroy', data.id));
        }
    };
                            ...
                            <div className="col-12">
                                <div className="row align-items-end justify-content-between g-3">
                                    ...
                                    <div className="col-sm-auto btn-page">
                                        <a href={route('scpagos.index')} className="btn btn-outline-secondary">Cancelar</a> 
