...
export default function Edit({ sgrolesperfiles}: Props) {
    const { data, setData, put, delete: destroy, processing, errors } = useForm({
        id: sgrolesperfiles.id || '',
        
        perfil_id: sgrolesperfiles.perfil_id || '',
                             
        rol_id: sgrolesperfiles.rol_id || '',
                             
        estado: sgrolesperfiles.estado || '',
                             
        observacion: sgrolesperfiles.observacion || '',
                             
        created_by: sgrolesperfiles.created_by || '',
                             
        updated_by: sgrolesperfiles.updated_by || '',
                             
        deleted_by: sgrolesperfiles.deleted_by || '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('sgrolesperfiles.update', data.id));
    };

    const handleDelete = () => {
        if (confirm('¿Seguro que quiere eliminar este elemento?')) {
            destroy(route('sgrolesperfiles.destroy', data.id));
        }
    };
                            ...
                            <div className="col-12">
                                <div className="row align-items-end justify-content-between g-3">
                                    ...
                                    <div className="col-sm-auto btn-page">
                                        <a href={route('sgrolesperfiles.index')} className="btn btn-outline-secondary">Cancelar</a> 
