...
<nav class="pc-sidebar">
  <div class="navbar-wrapper">
    <div class="m-header">
        ...
        <img src="{{ asset('assets/images/logo-dark.svg') }}" type="image/svg+xml" class="img-fluid logo-lg" alt="logo">
      </a>
    </div>
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="{{route('cfmaestra.index')}}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-brand-chrome"></i></span>
            <span class="pc-mtext">Maestra</span>
          </a>
        </li>
      </ul>
      ...
      <div class="row">
        ...
        <div class="col-auto my-1">
          <ul class="list-inline footer-link mb-0">
            <li class="list-inline-item"><a href="{{route('dashboard')}}">Inicio</a></li>
          </ul>
        </div>
      </div>
    </div>
